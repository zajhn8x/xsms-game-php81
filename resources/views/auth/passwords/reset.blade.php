...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 compass-gradient-bg">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center compass-fade-in">
            ...
            <h2 class="text-3xl font-extrabold text-white mb-2">Đặt lại mật khẩu</h2>
            <p class="text-blue-100">Tạo mật khẩu mới cho tài khoản của bạn</p>
        </div>
        ...
        <div class="compass-card bg-white/95 backdrop-blur-sm border-0 shadow-2xl compass-slide-up">
            <div class="compass-card-body p-8">
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <!-- New Password Input -->
                    <div>
                        <label for="password" class="compass-label">Mật khẩu mới</label>
                    ...
                    <div>
                        <label for="password-confirm" class="compass-label">Xác nhận mật khẩu mới</label>
