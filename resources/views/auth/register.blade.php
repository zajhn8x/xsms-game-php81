...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 compass-gradient-bg">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center compass-fade-in">
            ...
            <h2 class="text-3xl font-extrabold text-white mb-2">Đăng ký</h2>
            <p class="text-blue-100">Tạo tài khoản mới để trải nghiệm XSMB Game</p>
        </div>
        ...
        <div class="compass-card bg-white/95 backdrop-blur-sm border-0 shadow-2xl compass-slide-up">
            <div class="compass-card-body p-8">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Name Input -->
                    <div>
                        <label for="name" class="compass-label">Họ và tên</label>
                        <div class="relative">
                            ...
                            <input id="name" type="text" name="name"
                                   class="compass-input pl-10 @error('name') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="phone" class="compass-label">Số điện thoại <span class="text-gray-400">(tùy chọn)</span></label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input id="phone" type="tel" name="phone"
                                   class="compass-input pl-10 @error('phone') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="password-confirm" class="compass-label">Xác nhận mật khẩu</label>
                        <div class="relative" x-data="{ showConfirmPassword: false }">
                            ...
                            <input id="password-confirm"
                                   ...
                                   class="compass-input pl-10 pr-10"
