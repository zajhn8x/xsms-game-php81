...
{
    protected $signature = 'lottery:run-campaign {cau_lo_id} {start_date} {so_ngay}';
    ...
    public function handle()
    {
        ...
        $streakFormulas = $this->formulaHitService->getStreakFormulas($startDate->format('Y-m-d'), 4, 1);
        Log::info("ok",[$streakFormulas]);
